...
export const LEVELS = [
  ...
  },
  {
    ...
    grid: (() => {
      ...
      return [[_,_,_,_,_,_,_,_,S,_],[_,_,_,_,_,_,_,S,D,_],[_,_,_,_,_,_,S,D,_,_],[_,_,_,_,_,S,D,_,_,_],[_,G,G,_,S,D,_,_,_,_],[G,G,G,G,S,_,_,_,_,_],[_,G,G,B,_,_,_,_,_,_],[_,_,B,B,B,_,_,_,_,_],[_,B,B,_,B,B,_,_,_,_],[_,_,_,_,_,_,_,_,_,_]];
    })(),
  },
];
